...
class QuizManager {
    ...
    private var _totalCorrectAnswers = 0 //Estão como private pois não quero que a outra classe manipule os dados, apenas leia-os
    
    var question: String { // variável computada para resgatar o valor e exibir para classes externas
    ...
    func refreshQuiz() {
        let indexQuiz = Int(arc4random_uniform(UInt32(quizes.count)))
        let quizData = quizes[indexQuiz]
